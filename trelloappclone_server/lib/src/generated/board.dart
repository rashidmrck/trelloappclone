...
class Board extends _i1.TableRow {
  ...
  factory Board.fromJson(
    ...
    return Board(
      ...
      discription: serializationManager
          .deserialize<String?>(jsonSerialization['discription']),
      ...
      stared:
          serializationManager.deserialize<bool?>(jsonSerialization['stared']),
